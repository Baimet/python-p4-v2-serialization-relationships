...
class Zookeeper(db.Model, SerializerMixin):
    ...
    serialize_rules = ('-animals.zookeeper',)  # exclude the zookeeper from the animals
...
class Enclosure(db.Model, SerializerMixin):
    ...
    # exclude the enclosure from the animals
...
class Animal(db.Model, SerializerMixin):
    ...
    # exclude the zookeeper and enclosure from the animals
